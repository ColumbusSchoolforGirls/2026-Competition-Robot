...
public class Drivetrain {
  ...
  private final AbsoluteEncoderInterface frontLeftAboluteEncoder = new DutyCycleAbsoluteEncoder(DriveConstants.FL_DIO);
  private final AbsoluteEncoderInterface backLeftAbsoluteEncoder = new CANAbsoluteEncoder(DriveConstants.BL_ENCODER_CAN_ID);
  private final AbsoluteEncoderInterface frontRightAbsoluteEncoder = new DutyCycleAbsoluteEncoder(DriveConstants.FR_DIO);
  private final AbsoluteEncoderInterface backRightAbsoluteEncoder = new DutyCycleAbsoluteEncoder(DriveConstants.BR_DIO);
